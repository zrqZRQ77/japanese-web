// 📦 2026最新重构：彻底分离的跨科目日语教材大数据库（全量标准版）
export const examDatabase = {
  boki3: {
    ch1: {
      ...
      content: [
        ...
        "すべての取引は、「資産」「負資産（負債）」「純資産」「費用」「収益」の5つのグループのいずれかに分类されます。",
    ...
    ch3: {
      ...
      content: [
        "商品売買の記録方法として、日本では「三分法（さんぶんぽう）」が最も一般的です。これは商品を「仕入（費用）」「売上（収益）」「繰越商品（資産）」の3つの勘定科目で処理する方法です。",
  ...
  boki2: {
    ch1: {
      ...
      title: "株式会社の会計・純資産の部",
      content: [
        "簿記2級では、個人商店ではなく「株式会社」を前提とした高度な商業簿記を学びます。",
        "株主から出資を受けた金額は、原則として全額を資本金（純資産）として処理します。会社法の規定により、出资額の2分の1を超えない範囲で「資本準備金」として積み立てることも認められています。"
      ]
    }
  },
  fp3: {
  ...
  itpass: {
    ch1: {
      ...
      content: [
        "人間の知的創作活動によって生み出された利益を保護するための「知的財产権」について学びます。",
